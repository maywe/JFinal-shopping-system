...
<!-- 系统用户管理 -->
<!-- 列表 start-->
<div class="tab-pane animated fadeInDown my-tab-pane" id="goodsBigTypeListBox">
    <div class="portlet col-xs-12 padding0">
        <div class="portlet-title themes-portlet-title">
            ...
            <div class="col-xs-11 p-r-0">
                <form id="goodsBigTypeListForm" class="form-inline" onsubmit="return false">
                    ...
                    <button onclick="paginationBreak('goodsBigTypeListBox')" type="button" class="btn btn-xs btn-info">
        ...
        <div class="portlet-box themes-portlet-box">
            <table class="table table-condensed table-bordered table-hover">
                ...
                <tbody>
                    <c:forEach items="${pageUtil.list}" var="gbt" varStatus="status">
                        <tr>
                            <td>${status.count}</td>
                            ...
                            <td>
                                ...
                                <button onclick="deleteCallSubmit(this,'/goodsBigTypeCtrl/deleteData','goodsBigTypeListBox',{'goodsBigType.goods_big_type_id':${gbt.goods_big_type_id}})" type="button" class="btn btn-xs btn-info" data-deleteInfo="删除后不可恢复!您确定要删除?">
...
<div class="navbar-fixed-bottom pageFooter themes-pageFooter">
    <div class="pagination-select">
        ...
        <div class="select-pagesize">
            <select name="pageSize" onchange="paginationBreak('goodsBigTypeListBox')">
